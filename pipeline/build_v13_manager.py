...
def build_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "competition": {
            ...
            "registration_window": "After R22 is complete and before the R23 team lock.",
            "evidence": "Designated team at registration plus end-of-season official-score screenshot; private league retained as a verification fallback.",
            "prizes_usd": [100, 50, 30],
            "eligibility_note": "Final eligibility and payout terms will be published before registration opens.",
        },
        "research_replay": {

---
title: Belgian GP F1 Fantasy: Why Max Leads
date: 2026-07-13
round: 12
...
That is why the [Max Verstappen profile](/drivers/max-verstappen/) shows both figures and the full confidence range. A single headline projection would hide the most important part of the decision.
...
1. **Mercedes:** 54.8 expected points, $31.7M, 1.73 PPM, P5 floor 4.5.
2. **Ferrari:** 41.0 expected points, $25.7M, 1.60 PPM, P5 floor 0.6.
3. **Red Bull:** 40.2 expected points, $30.0M, 1.34 PPM, P5 floor -10.3.
4. **McLaren:** 29.0 expected points, $30.1M, 0.96 PPM, P5 floor -8.5.
5. **Racing Bulls:** 21.0 expected points, $11.1M, a field-leading 1.89 PPM, P5 floor -11.1.
...
This snapshot is a starting point, not a command. Use the [Lineup Optimizer](/tools/lineup-optimizer/) with your real budget, locks, exclusions and chip choice. Use [Team Compare](/tools/team-compare/) if you are deciding between Max, Kimi or Russell builds.
...
1. **Repeatable qualifying pace:** not just one fastest lap, but whether Max, Mercedes and Ferrari can repeat competitive laps.
2. **Long-run evidence:** useful for race confidence, even though practice fuel loads remain unknown.
3. **Reliability and session completion:** missed running can widen uncertainty rather than clarify it.
4. **Weather alignment:** the model should be rerun against the latest forecast instead of relying on the July 9 snapshot.
...
The honest pre-practice decision is therefore conditional: Max is the leading upside candidate, Kimi offers the strongest current downside floor, Russell has the best recent premium-driver form, and Lindblad is the clearest value enabler. Recheck the [Belgian GP race-week page](/picks/belgian-gp-2026/) after practice before committing transfers or a chip.
